...
const Courses = () => {
  const courses = [
    ...
    {
      title: "Robotics 101 pour enseignants",
      description: "Introduction aux fondamentaux de la robotique qui vous fournira les connaissances de base pour comprendre...",
      link: "/robotics",
    },
    {
